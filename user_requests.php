...
// Corrected role check: Should be 'user' based on our database table
...
try {
    // NOTE: You do not need to fetch BLOB data here, as download_complete.php handles it.
    // Ensure you select all necessary columns *except* completed_file_path (if removed).
    $stmt = $pdo->prepare("
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ( $project['status'] === 'completed' ): ?>
                                            <a href="download_complete.php?request_id=<?= $project['id']; ?>" class="btn btn-sm btn-info text-dark">
